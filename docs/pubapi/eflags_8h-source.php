...
<title>eflags.h Source File</title>
...
<hr><h1>eflags.h</h1><div class="fragment"><pre>00001 <span class="comment">/*</span>
...
00021 
00022 <span class="preprocessor">#ifndef __AELIB_AEENGINE_EFLAGS_H__</span>
00023 <span class="preprocessor"></span><span class="preprocessor">#define __AELIB_AEENGINE_EFLAGS_H__</span>
...
<a name="l00030"></a><a class="code" href="structaeEngineflags.php">00030</a> <span class="keyword">struct </span><a class="code" href="structaeEngineflags.php">aeEngineflags</a> {
<a name="l00032"></a><a class="code" href="structaeEngineflags.php#m0">00032</a>         <span class="keywordtype">bool</span> <a class="code" href="structaeEngineflags.php#m0">hasMultitexture</a>;
00034 
<a name="l00039"></a><a class="code" href="structaeEngineflags.php#m1">00039</a>         <span class="keywordtype">bool</span> <a class="code" href="structaeEngineflags.php#m1">doMultipass</a>;
<a name="l00041"></a><a class="code" href="structaeEngineflags.php#m2">00041</a>         <span class="keywordtype">int</span> <a class="code" href="structaeEngineflags.php#m2">texUnits</a>;
00042 };
00043 
00044 <span class="preprocessor">#endif // __AELIB_AEENGINE_EFLAGS_H__</span>
