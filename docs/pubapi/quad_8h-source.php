...
<title>quad.h Source File</title>
...
<hr><h1>quad.h</h1><div class="fragment"><pre>00001 <span class="comment">/*</span>
...
00021 
00022 <span class="preprocessor">#ifndef __AELIB_AEGEOM_QUAD_H__</span>
00023 <span class="preprocessor"></span><span class="preprocessor">#define __AELIB_AEGEOM_QUAD_H__</span>
...
00030 
<a name="l00035"></a><a class="code" href="classaeQuad.php">00035</a> <span class="keyword">class </span><a class="code" href="classaeQuad.php">aeQuad</a>: <span class="keyword">public</span> <a class="code" href="classaeObject.php">aeObject</a> {
00036         AECF_CNDEF
00037 
00038  <span class="keyword">public</span>:
00044         <a class="code" href="classaeQuad.php#a0">aeQuad</a>();
00045 
00051         <a class="code" href="classaeQuad.php#a0">aeQuad</a>(<span class="keywordtype">char</span> *);
00052         <span class="keyword">virtual</span> ~<a class="code" href="classaeQuad.php">aeQuad</a>();
00053 
00059         <span class="keywordtype">void</span> <a class="code" href="classaeQuad.php#a3">Draw</a>(<a class="code" href="structaeEngineflags.php">aeEngineflags</a> *);
00060 };
00061 
00062 <span class="preprocessor">#endif // __AELIB_AEGEOM_QUAD_H__</span>
