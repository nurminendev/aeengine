...
<hr><h1>system.h</h1><div class="fragment"><pre>00001 <span class="comment">/*</span>
...
00021 
00022 <span class="preprocessor">#ifndef __AELIB_AESYS_SYSTEM_H__</span>
00023 <span class="preprocessor"></span><span class="preprocessor">#define __AELIB_AESYS_SYSTEM_H__</span>
00024 <span class="preprocessor"></span>
00025 <span class="preprocessor">#include &lt;aedefs.h&gt;</span>
00026 <span class="preprocessor">#include &lt;aeengine/engine.h&gt;</span>
00027 <span class="preprocessor">#include &lt;aereg/base.h&gt;</span>
00028 <span class="preprocessor">#include &lt;aereg/registry.h&gt;</span>
00029 
00030 <span class="comment">// Forward declarations</span>
00031 <span class="keyword">class </span><a class="code" href="classaeRegistry.php">aeRegistry</a>;
00032 <span class="keyword">class </span><a class="code" href="classaeEngine.php">aeEngine</a>;
00033 
<a name="l00037"></a><a class="code" href="classaeSystem.php">00037</a> <span class="keyword">class </span><a class="code" href="classaeSystem.php">aeSystem</a>: <span class="keyword">public</span> <a class="code" href="classaeBase.php">aeBase</a> {
00038         AECF_CNDEF
00039 
00040  <span class="keyword">private</span>:
00041         <a class="code" href="classaeRegistry.php">aeRegistry</a> *aereg;
00042 
00043  <span class="keyword">public</span>:
00044         <a class="code" href="classaeSystem.php">aeSystem</a>(<a class="code" href="classaeRegistry.php">aeRegistry</a> *registry);
00045         ~<a class="code" href="classaeSystem.php">aeSystem</a>();
00046 
00055         <span class="keywordtype">void</span> <a class="code" href="classaeSystem.php#a2">SetWindowCaption</a>(<span class="keywordtype">char</span> *icon, <span class="keywordtype">char</span> *caption, ...);
00056 };
00057 
00058 <span class="preprocessor">#endif // __AELIB_AESYS_SYSTEM_H__</span>
