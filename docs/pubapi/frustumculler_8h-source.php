...
<title>frustumculler.h Source File</title>
...
<hr><h1>frustumculler.h</h1><div class="fragment"><pre>00001 <span class="comment">/*</span>
...
00021 
00022 <span class="preprocessor">#ifndef __AELIB_AEENGINE_FRUSTUMCULLER_H__</span>
00023 <span class="preprocessor"></span><span class="preprocessor">#define __AELIB_AEENGINE_FRUSTUMCULLER_H__</span>
...
00029 <span class="preprocessor">#include &lt;aereg/base.h&gt;</span>
00030 
<a name="l00035"></a><a class="code" href="classaeFrustumCuller.php">00035</a> <span class="keyword">class </span><a class="code" href="classaeFrustumCuller.php">aeFrustumCuller</a>: <span class="keyword">public</span> <a class="code" href="classaeBase.php">aeBase</a> {
00036         AECF_CNDEF
00037 
00038  <span class="keyword">private</span>:
00039         <span class="keywordtype">float</span> frustum[6][4];
00040 
00041  <span class="keyword">public</span>:
00042         <a class="code" href="classaeFrustumCuller.php">aeFrustumCuller</a>();
00043         ~<a class="code" href="classaeFrustumCuller.php">aeFrustumCuller</a>();
00044 
00049         <span class="keywordtype">void</span> <a class="code" href="classaeFrustumCuller.php#a2">ExtractFrustum</a>();
00050 
00058         <span class="keywordtype">bool</span> <a class="code" href="classaeFrustumCuller.php#a3">PointInFrustum</a>(<a class="code" href="classaeVector3.php">aeVector3</a> point);
00059 
00068         <span class="keywordtype">bool</span> <a class="code" href="classaeFrustumCuller.php#a4">SphereInFrustum</a>(<a class="code" href="classaeVector3.php">aeVector3</a> center, <span class="keywordtype">float</span> radius);
00069 
00078         <span class="keywordtype">bool</span> <a class="code" href="classaeFrustumCuller.php#a5">CubeInFrustum</a>(<a class="code" href="classaeVector3.php">aeVector3</a> center, <span class="keywordtype">float</span> size);
00079 };
00080 
00081 <span class="preprocessor">#endif // __AELIB_AEENGINE_FRUSTUMCULLER_H__</span>
