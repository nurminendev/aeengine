...
<title>ctimer.h Source File</title>
...
<hr><h1>ctimer.h</h1><div class="fragment"><pre>00001 <span class="comment">/*</span>
...
00021 
00022 <span class="preprocessor">#ifndef __AELIB_AEENGINE_CTIMER_H__</span>
00023 <span class="preprocessor"></span><span class="preprocessor">#define __AELIB_AEENGINE_CTIMER_H__</span>
...
00029 
<a name="l00037"></a><a class="code" href="classaeCTimer.php">00037</a> <span class="keyword">class </span><a class="code" href="classaeCTimer.php">aeCTimer</a>: <span class="keyword">public</span> <a class="code" href="classaeBase.php">aeBase</a> {
00038  <span class="keyword">private</span>:
00039         <span class="keywordtype">float</span> FPS;
00040         <span class="keywordtype">float</span> FPScounter;
00041         <span class="keywordtype">float</span> FrameInterval;
00042         <span class="keywordtype">float</span> FrameTime;
00043         <span class="keywordtype">float</span> LastFrameTime;
00044         <span class="keywordtype">float</span> currentTime;
00045 
00046  <span class="keyword">public</span>:
00047         <a class="code" href="classaeCTimer.php">aeCTimer</a>();
00048         ~<a class="code" href="classaeCTimer.php">aeCTimer</a>();
00049 
<a name="l00056"></a><a class="code" href="classaeCTimer.php#a2">00056</a>         <span class="keywordtype">float</span> <a class="code" href="classaeCTimer.php#a2">GetFPS</a>()<span class="keyword"> const </span>{ <span class="keywordflow">return</span> FPS; }
00057 
<a name="l00065"></a><a class="code" href="classaeCTimer.php#a3">00065</a>         <span class="keywordtype">float</span> <a class="code" href="classaeCTimer.php#a3">GetFrameInterval</a>()<span class="keyword"> const </span>{ <span class="keywordflow">return</span> FrameInterval; }
00066 
00071         <span class="keywordtype">void</span> <a class="code" href="classaeCTimer.php#a4">CalculateFrameRate</a>();
00072 };
00073 
00074 <span class="preprocessor">#endif // __AELIB_AEENGINE_CTIMER_H__</span>
