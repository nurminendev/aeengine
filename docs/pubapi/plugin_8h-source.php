...
<hr><h1>plugin.h</h1><div class="fragment"><pre>00001 <span class="comment">/*</span>
...
00021 
00022 <span class="preprocessor">#ifndef __AELIB_AEPLUGIN_PLUGIN_H__</span>
00023 <span class="preprocessor"></span><span class="preprocessor">#define __AELIB_AEPLUGIN_PLUGIN_H__</span>
...
00029 
00034 <span class="keyword">enum</span> aePluginID {
00035         AE_PLUGIN_aeModelLoader,
00036         AE_PLUGIN_aeTerrMan,
00037         AE_PLUGIN_aeTextureLoader
00038 };
00039 
<a name="l00045"></a><a class="code" href="classaePlugin.php">00045</a> <span class="keyword">class </span><a class="code" href="classaePlugin.php">aePlugin</a>: <span class="keyword">public</span> <a class="code" href="classaeBase.php">aeBase</a> {
00046  <span class="keyword">public</span>:
00047         <span class="keyword">virtual</span> ~<a class="code" href="classaePlugin.php">aePlugin</a>() {}
00048 
<a name="l00050"></a><a class="code" href="classaePlugin.php#m0">00050</a>         aePluginID <a class="code" href="classaePlugin.php#m0">myID</a>;
00051 
<a name="l00059"></a><a class="code" href="classaePlugin.php#a1">00059</a>     aePluginID <a class="code" href="classaePlugin.php#a1">GetPluginID</a>()<span class="keyword"> const </span>{ <span class="keywordflow">return</span> myID; }
00060 };
00061 
00062 <span class="preprocessor">#endif // __AELIB_AEPLUGIN_PLUGIN_H__</span>
