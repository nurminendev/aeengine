...
#ifndef __AELIB_AEGEOM_POLYGON_H__
#define __AELIB_AEGEOM_POLYGON_H__
 ...
 * 
 */
class aePolygon: public aeObject {
	AECF_CNDEF
 ...
 public:
	 ...
	 * 
	 * @param char * The polygon's name.
	 */
	aePolygon(char *);
	virtual ~aePolygon();

	/** 
	 * Draw the polygon. This is called by aeEngine::Render(). You shouldn't need to call this
	 * yourself.
	 * 
	 */
...
#endif // __AELIB_AEGEOM_POLYGON_H__
